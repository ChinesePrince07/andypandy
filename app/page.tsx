...
const btnClass =
  "liquid-glass inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm text-gray-600 transition-all hover:shadow-md active:scale-[0.98] dark:text-gray-300";
  ...
  return (
    <div className="space-y-12 animate-fade-in">
      ...
      >
        ...
        <Link href="/blog" className={btnClass}>
          Read the blog &rarr;
        </Link>
      </div>
