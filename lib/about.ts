...
const defaultAbout: AboutData = {
  ...
  timeline: [
    { year: "2025", title: "Senior Year — Suffield Academy", description: "Full-stack web development, personal projects, and college prep." },
    { year: "2024", title: "Junior Year — Suffield Academy", description: "Deep dive into IoT, embedded systems with ESP32, and calculator hacking." },
    { year: "Summer 2024", title: "Summer Projects", description: "Built side projects, explored machine learning, and sharpened coding skills." },
    { year: "Summer 2023", title: "Getting Started", description: "First steps into programming — Python scripting, HTML/CSS, and hardware tinkering." },
  ],
};
